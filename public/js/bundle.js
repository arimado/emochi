...
exports.default = function (props) {
    ...
    var chatList = props.chats.map(function (chat) {
        ...
        var currentMembers = chat.members.map(function (member) {
            var memberName = '';
        ...
        return _react2.default.createElement(
            ...
            _react2.default.createElement(
                _reactRouter.Link,
                { className: 'chatListItem', onClick: props.setChat.bind(undefined, chat._id), to: '/chats/' + chat._id },
                _react2.default.createElement(
                    'div',
                    null,
                    _react2.default.createElement(
